      ...
      <div className="mx-auto max-w-lg py-6">
        {roomInfo?.status === "closed" ? (
          <ParticipationStatusCard
            title={currentUserHasVoted ? "ທ່ານໂຫວດແລ້ວ" : "ທ່ານບໍ່ໄດ້ໂຫວດ"}
            description={
              currentUserHasVoted
                ? "ລະບົບບັນທຶກຄະແນນຂອງທ່ານແລ້ວ"
        ...
        {participation ? (
          <div className="mx-4 mb-4 grid grid-cols-3 gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div>
