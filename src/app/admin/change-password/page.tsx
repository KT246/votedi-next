    ...
    return (
        <div className="min-h-screen bg-slate-50 px-4 py-8">
            <div className="mx-auto max-w-lg">
                <div className="mb-6">
                    <p className="text-sm font-medium text-slate-500">ບັນຊີ: <span className="font-mono text-slate-700">{adminUser?.username || '-'}</span></p>
                    <h1 className="mt-2 text-3xl font-bold text-slate-900">ປ່ຽນລະຫັດຜ່ານ</h1>
                    <p className="mt-2 text-sm text-slate-500">ປ່ຽນລະຫັດຜ່ານຂອງບັນຊີ admin ທີ່ກຳລັງໃຊ້ຢູ່</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-5 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                    <div>
                        <label className="mb-2 block text-sm font-semibold text-slate-700">ລະຫັດຜ່ານປັດຈຸບັນ</label>
                        <input
                            type="password"
                            value={form.current}
                    ...
                    <div>
                        <label className="mb-2 block text-sm font-semibold text-slate-700">ລະຫັດຜ່ານໃໝ່</label>
                        <input
                            type="password"
                            value={form.next}
